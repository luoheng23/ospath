...
final class NTPathTests: XCTestCase {
  ...
  func testJoin() {
    ...
    XCTAssertEqual(NTPath.join("c:/a/b", "x/y"), "c:/a/b\\x/y")
    XCTAssertEqual(NTPath.join("c:/a/b/", "x/y"), "c:/a/b/x/y")
    XCTAssertEqual(NTPath.join("//computer/share", "x/y"), "//computer/share\\x/y")
    XCTAssertEqual(NTPath.join("//computer/share/", "x/y"), "//computer/share/x/y")
    XCTAssertEqual(NTPath.join("//computer/share/a/b", "x/y"), "//computer/share/a/b\\x/y")
    ...
    XCTAssertEqual(NTPath.join("//computer/share", "/x/y"), "//computer/share/x/y")
    XCTAssertEqual(NTPath.join("//computer/share/", "/x/y"), "//computer/share/x/y")
    XCTAssertEqual(NTPath.join("//computer/share/a", "/x/y"), "//computer/share/x/y")
    ...
    XCTAssertEqual(NTPath.join("\\\\computer\\share\\", "a", "b"), "\\\\computer\\share\\a\\b")
    XCTAssertEqual(NTPath.join("\\\\computer\\share", "a", "b"), "\\\\computer\\share\\a\\b")
    XCTAssertEqual(NTPath.join("\\\\computer\\share", "a\\b"), "\\\\computer\\share\\a\\b")
    XCTAssertEqual(NTPath.join("//computer/share/", "a", "b"), "//computer/share/a\\b")
    XCTAssertEqual(NTPath.join("//computer/share", "a", "b"), "//computer/share\\a\\b")
  ...
  func testNormpath() {
    ...
    XCTAssertEqual(NTPath.normpath("C:////a/b"), "C:\\a\\b")
    XCTAssertEqual(NTPath.normpath("//machine/share//a/b"), "\\\\machine\\share\\a\\b")
